	...
	<div align="center">
						...
						<tr>
							<td colspan="2">
								<form action="loginAction.action" method="post">
									<p>
										<img src="img\user.png" style="width:40px">用户: <input
											type="text" name="userName" id="userName" style="width:100px" />
									</p>
									<p>
										<img src="img\psw.png" style="width:40px">密码: <input
											type="password" name="password" id="password"
											style="width:100px" />
									</p>
									<p><s:property value="message"/><br></p>
									<div align="right">
	    ...
	    <tr>
	    	<td colspan="2">
				...
				<td valign="top">
					<div align="center">
						<iframe src="jsp/main.jsp" name="main" scrolling="no"
