...
<html>
<head>
    <title>北京邮电大学|图片管理系统|普通用户</title>
...
<div id="container">
    ...
    <div id="mainSection">
        <div id="leftSection">
            ...
            <div id="functions">
                <ul type="none">
                    <li v-for="normalFunction in normalFunctions"><a :href="normalFunction.href" target="main" :title="normalFunction.title">{{normalFunction.title}}</a></li>
                </ul>
            </div>
        </div>
        <div id="rightSection">
