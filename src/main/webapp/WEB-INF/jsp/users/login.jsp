        ...
        <div id="mainSection">
            <div id="leftSection">
            	<header class="leftHeader">
                	<a href="javascript:;" class="lHeader" @click="headerToggle">用户登录</a>
                </header>
                	...
                	<form id="loginForm" action="loginAction" method="post">
                		<div id="login_inputSec">
							<p v-for="loginInput in loginInputs">
								...
								<input :type="loginInput.type" :id="loginInput.id" :class="loginInput.class" :name="loginInput.name" :placeholder="loginInput.placeholder" @focus="inputFocus"/>
							</p>
                		</div>
						<el-button type="success" id="loginBtn" @click="onLogin">登录</el-button>
                	</form>
                </div>
                <header class="leftHeader">
