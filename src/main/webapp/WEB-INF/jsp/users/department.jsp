...
<html>
<head>
    <title>北京邮电大学|图片管理系统|部门管理员</title>
...
<div id="container">
    ...
    <div id="mainSection">
        <div id="leftSection">
            ...
            <div id="functions">
                <ul type="none">
                    <li v-for="departmentFunction in departmentFunctions"><a :href="departmentFunction.href" target="main" :title="departmentFunction.title">{{departmentFunction.title}}</a></li>
                </ul>
            </div>
        </div>
        <div id="rightSection">
