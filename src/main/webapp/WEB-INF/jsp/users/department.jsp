  ...
  <body>
 	<div id="container">
        <header>
            ...
            <nav id="navBar">
                <ul>
                    <li><a href="jsp/depAdmin.jsp" title="首页">首页</a></li>
            ...
            <div id="leftSection">
                ...
                <div id="functions">
                    ...
                    <ul type="none">
                        ...
                        <li><a href="#" target="main" title="上传照片-部门管理员">上传照片</a></li>
                        <li><a href="#" target="main" title="下载照片-部门管理员">下载照片</a></li>
                        <li><a href="#" target="main" title="部门用户管理">部门用户管理</a></li>
                    </ul>
                </div>
            </div>
            <div id="rightSection">
