...
<div id="container">
    ...
    <div id="mainSection">
        <div id="leftSection">
            <div id="userSection">
                ...
                <div id="information">
                    ...
                    <p>权限：普通用户</p>
                    <p><a href="jsp/userInformation.jsp" target="main"
                          class="button button-glow button-border button-rounded button-tiny button-primary"/>查看</a></p>
                </div>
            ...
            <div id="searchSection">
                ...
                <form id="searchForm">
                    <div id="inputSec">
                        ...
                        <input type="text" name="keywords" id="keywords" placeholder="请输入关键词" size="15" maxlength="25"
                               required="required"/>
                    </div>
                    <div id="searchBtn">
                        <input type="submit" value="搜索" name="search"
                               class="button button-3d button-action button-pill button-tiny"/>
                        <input type="reset" value="清空" name="reset"
                               class="button button-3d button-caution button-pill button-tiny"/>
                    </div>
                </form>
        ...
        <div id="rightSection">
            <iframe src="#" name="main" allowtransparency="true" scrolling="no" frameborder="0" marginwidth="0"
                    marginheight="0">
            </iframe>
        </div>
    </div>
    <footer>
        <address>Beijing University of Posts and Telecommunications 2016 Photo Album</address>
    </footer>
</div>
</body>
</html>
